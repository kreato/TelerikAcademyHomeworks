...
{
    class ExtractStudentsByMarksMain
    {
        static void Main()
        {
            List<Student> students = new List<Student>
            {
                ...
                new Student("Yajo", "Sekvoev", "40863","+35949659305","yajo@abv.bg",new List<int>{2,4,5,2,2,3,4,2}, 1),
            ...
            var studentsWithMark6 = from student in students
